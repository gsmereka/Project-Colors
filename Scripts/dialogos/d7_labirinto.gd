...
var _dialog_data: Dictionary = {
	0: {
		"faceset":"res://Sprites/Dialogo/ham/ham2.png",
		"dialog": "Mais um labirinto... Tem alguma dica caveira?",
		"title": "Ham"
	},
	1: {
		"faceset": "res://Sprites/Dialogo/Caveira/cav3.png",
		"dialog": "Não olha pra mim, eu só faço iluminar seu caminho.",
		"title": "Caveira"
	}
}
